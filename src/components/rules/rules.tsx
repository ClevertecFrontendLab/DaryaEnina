...
export const Rules = () => (
  <div className='contract__container'>
    <h2 className='contract__title'>Правила пользования</h2>
    <ol className='contract__items'>
      <li className='contract__list_item'>
        <span className='item_level1'>
        ...
        <ol className='contract__list_leve1'>
          <li className='contract__list_item'>
